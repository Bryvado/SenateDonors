...
- Cache-busting query strings: `app.js?v=10` and `style.css?v=10` in `index.html`, `states.json?v=2`, `zctas/*.bin?v=3` and `levels/geo/*.bin?v=1` in `app.js`. Bump when those files change.
